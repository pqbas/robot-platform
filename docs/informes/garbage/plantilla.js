...
const {
  ...
  ShadingType, PageNumber, PageBreak, LevelFormat, TableOfContents, ImageRun,
} = require("docx");

// --- Cover images (from INFORME original) ---
const BANNER_PATH = "/tmp/informe_unpacked/word/media/image8.jpg";
const LOGO_PATH = "/tmp/informe_unpacked/word/media/image1.jpg";
    ...
    // ===================== PORTADA =====================
    {
      ...
      children: [
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          spacing: { after: 200 },
          children: [new TextRun({ text: "PE5010-86701-2024-PROCIENCIA", font: FONT, size: 24, bold: true })],
        }),
        // Linea separadora
        new Paragraph({
          border: { bottom: { style: BorderStyle.SINGLE, size: 6, color: "4472C4", space: 1 } },
          children: [],
        }),
        emptyLine(),
        // Numero de informe
        ...
        new Paragraph({
          ...
          children: [new TextRun({
            ...
            font: FONT, size: 24, color: COLOR_PLACEHOLDER, italics: true,
          })],
        }),
        emptyLine(),
        // Autores
        new Paragraph({
          spacing: { after: 100 },
          children: [new TextRun({ text: "Nombre del autor:", font: FONT, size: 22 })],
        }),
        bullet("Percy Brayam Cubas Mu\u00F1oz"),
        bullet("Diana Rebecca, Rodriguez Ruiz"),
        bullet("Elver Joel, Sandoval Salinas"),
        bullet("Wilder, Oblitas D."),
        emptyLine(), emptyLine(), emptyLine(),
        // Ubicacion y fecha
        new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "Trujillo - Per\u00FA", font: FONT, size: 22 })] }),
        new Paragraph({
          alignment: AlignmentType.CENTER,
